"""
Ref:
https://github.com/adap/flower/blob/main/examples/embedded-devices/generate_dataset.py
https://github.com/adap/flower/blob/main/examples/quickstart-pytorch/pytorchexample/task.py
"""
...
def save_dataset_to_disk(num_partitions: int):
    """This function loads partition CIFAR10 data and saves it to disk.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Save CIFAR10 dataset partitions to disk"
    )
